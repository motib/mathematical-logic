...
\begin{itemize}
\item \p{queens.pro} contains the four-queens problem in two encodings:
one given in Section 6.4 of the book and the other from exercise 1.
If the first literal entered is, for example, \p{p12}, the predicate
terminates with the empty set of clauses and the assignments to positive
literals give the answer.
